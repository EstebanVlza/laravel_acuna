        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('movil.store') }}" method="POST">
                    ...
                    <input type="text" name="almacenamiento" class="form-control my-2 "required>
                    <label>ram</label>
                    <input type="text" name="ram" class="form-control my-2 "required>
                    <label>bateria</label>
                    <input type="text" name="bateria" class="form-control my-2 "required>
                    <label>sistema operativo</label>
                    <input type="text" name="sistema_op" class="form-control my-2 "required>
